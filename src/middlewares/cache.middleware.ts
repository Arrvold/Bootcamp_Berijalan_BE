...
interface CachePresetOptions {
  ttl?: number;
  keyPrefix?: string;
}

export const CachePresets = {
  short: (options: CachePresetOptions = {}): CacheOptions => ({
    ttl: 60,
    keyPrefix: "short_cache",
    ...options, // Gabungkan dengan override dari pengguna
  }),

  medium: (options: CachePresetOptions = {}): CacheOptions => ({
    ttl: 300,
    keyPrefix: "medium_cache",
    ...options,
  }),

  long: (options: CachePresetOptions = {}): CacheOptions => ({
    ttl: 3600,
    keyPrefix: "long_cache",
    ...options,
  }),

  user: (options: CachePresetOptions = {}): CacheOptions => ({
    ttl: 600,
